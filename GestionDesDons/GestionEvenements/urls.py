...
from .views import EvenementList, EvenementDetails, EvenementCreate, EvenementUpdate, EvenementDelete
...
urlpatterns = [
    ...
    path('<int:pk>/supprimer/', EvenementDelete.as_view(), name='delete_evenement'),
]
